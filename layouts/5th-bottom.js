// 5th-bottom layout — two-row layout favoring the top row.
//
// Window count -> layout:
...
//   7+ windows: added to the row with fewest windows (top row first on tie)
